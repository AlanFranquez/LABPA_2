...
<main class="container mt-5">
	...
	<p><b>Numero de Referencia: </b><%= prodAreclamar.crearDT().getNumRef() %></p>
	<p>$<%= prodAreclamar.crearDT().getPrecio() %></p>
	<p><b>Proveedor: </b><%= prodAreclamar.crearDT().getNombreProveedor() %></p>
	<hr>
	<h3 class="mt-2">Realizar Reclamo</h3>
	<p style="color: dark-grey">Realiza tu reclamo, el mismo podrá ser visto unicamente por el proveedor</p>
	<form action="RealizarReclamo" method="POST">
			
		 <input type="hidden" name="prodReclamo" value="<%=prodAreclamar.getNumRef()%>">
		<textarea name="mensaje" required style="width: 90%; height: 400px;"  placeholder="Tuve un problema con el producto..."></textarea>
