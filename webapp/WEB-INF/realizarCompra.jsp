    ...
    <ul class="list-group list-group-flush">
        ...
        <% for(Item i : items) { %>
            <li class="list-group-item d-flex column p-2 align-items-center mt-2" style="border: 1px solid gray; border-radius: 5px">
                <div>
                    <img alt="Img del producto" src="media/<%= i.getProducto().getImagenes().getFirst() %>" style="height: 100px; width: 100px;">
                </div>
                <div>
                    <h4><%= i.getProducto().crearDT().getNombre() %></h4>
                    <p><b>Numero de Referencia: </b><%= i.getProducto().getNumRef() %></p>
                    ...
                    <form id="orderForm" action="realizarCompra" method="POST">
                        <div class="row mx-4">
                            <div class="col-12">
                                ...
                                <input type="text" id="nombre" class="form-control order-form-input" placeholder="Carlos" required />
                            </div>
                            <div class="col-sm-6">
                                <label class="form-label">Apellido</label>
                                <input type="text" id="apellido" class="form-control order-form-input" placeholder="Barragan" required />
                            </div>
                        </div>
                        ...
                        <div class="row mt-3 mx-4">
                            <div class="col-12">
                                ...
                                <input type="text" id="titular" class="form-control order-form-input" placeholder="BROU" required />
                            </div>
                        </div>
                        ...
                        <div class="row mt-3 mx-4">
                            <div class="col-12">
                                ...
                                <input type="text" id="numeroTarjeta" class="form-control order-form-input" placeholder="12345678" required />
                            </div>
                        </div>
                        ...
                        <div class="row mt-3 mx-4">
                            <div class="col-12">
                                ...
                                <input type="text" id="codigoSeguridad" class="form-control order-form-input" placeholder="456" required />
                            </div>
                        </div>
                        ...
                        <div class="row mt-3 mx-4">
                            <div class="col-12">
                                ...
                                <input type="date" id="fechaVencimiento" class="form-control order-form-input" required />
                            </div>
                        </div>
                        ...
                        <div class="row mt-3 mx-4">
                            <div class="col-sm-6 mt-2 ps-sm-0">
                                ...
                                <input type="text" id="ciudad" class="form-control order-form-input" placeholder="Trinidad" required />
                            </div>
                            <div class="col-sm-6 mt-2 ps-sm-0">
                                <label class="form-label" for="pais">País</label>
                                <input type="text" id="pais" class="form-control order-form-input" placeholder="Uruguay" required />
                            </div>
                        </div>
