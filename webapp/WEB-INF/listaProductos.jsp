    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <ul class="navbar-nav align-items-center">
                <li class="nav-item">
                    <% if (usr != null) { %>
                        <a class="nav-link" href="<%= usr.getTipo().equals("proveedor") ? "perfilProveedor" : "perfilCliente" %>?nickname=<%= usr.getNick() %>">Perfil</a>
                    <% } %>
                </li>
            ...
            <div id="collapseOne" class="accordion-collapse collapse collapse" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                <div class="accordion-body">
                    <form action="buscarproductos" method="POST">
                                <select name="ordenacion" class="form-select mb-2" onchange="this.form.submit()">
                                    <option value="">Seleccionar ordenación</option>
                                    <option value="alfabeticamente">Alfabéticamente (Ascendente)</option>
            ...
            <% for (DtProducto dt : listaDTProductos) { %>
                <div class="col-md-4 col-sm-6 mb-4">
                    <div class="card h-100 text-center">
                        <img class="card-img-top" src="media/<%= dt.getImagenes().getFirst() %>" alt="<%= dt.getNombre() %>" style="height: 200px; object-fit: cover;">
                        <div class="card-body d-flex flex-column">
                            ...
                            <p class="card-text"><span style="color: red;">Cantidad disponible:</span> <%= dt != null ? dt.getStock() : "N/A" %></p>
                            <div class="mt-auto">
                                <form action="agregarAlCarrito" method="post" style="display: inline-block;" onsubmit="return validarCantidad(this)">
                                    ...
                                    <input class="text-center" type="number" name="cantidad" min="1" max="<%= dt.getStock() %>" value="1" style="width: 60px;" onchange="validarCantidad(this.form)">
                                    <br>
                                    <div class="row mt-2">
