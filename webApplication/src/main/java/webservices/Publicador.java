...
public interface Publicador {
     ...
     */
    @WebMethod
    @RequestWrapper(localName = "agregarImagenProducto", targetNamespace = "http://services/", className = "webservices.AgregarImagenProducto")
    @ResponseWrapper(localName = "agregarImagenProductoResponse", targetNamespace = "http://services/", className = "webservices.AgregarImagenProductoResponse")
    @Action(input = "http://services/Publicador/agregarImagenProductoRequest", output = "http://services/Publicador/agregarImagenProductoResponse")
