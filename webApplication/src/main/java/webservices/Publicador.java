...
public interface Publicador {
    ...
    public void setRecibirNotificaciones(
        @WebParam(name = "arg0", targetNamespace = "")
        String arg0,
        @WebParam(name = "arg1", targetNamespace = "")
        boolean arg1);
    ...
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "getComprasUnicasProducto", targetNamespace = "http://services/", className = "webservices.GetComprasUnicasProducto")
    @ResponseWrapper(localName = "getComprasUnicasProductoResponse", targetNamespace = "http://services/", className = "webservices.GetComprasUnicasProductoResponse")
    @Action(input = "http://services/Publicador/getComprasUnicasProductoRequest", output = "http://services/Publicador/getComprasUnicasProductoResponse")
