 ...
 * 
 */
@WebServiceClient(name = "PublicadorService", targetNamespace = "http://services.market.com/", wsdlLocation = "http://localhost:1234/publicador?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PUBLICADORSERVICE_QNAME = new QName("http://services.market.com/", "PublicadorService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:1234/publicador?wsdl");
    ...
    public Publicador getPublicadorPort() {
        return super.getPort(new QName("http://services.market.com/", "PublicadorPort"), Publicador.class);
    }
    ...
    public Publicador getPublicadorPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://services.market.com/", "PublicadorPort"), Publicador.class, features);
    }
