		...
		<section class="row justify-content-center align-items-center">
			<div class="col-md-6 col-12 text-center">
				<img class="img-fluid rounded-circle"
					...
					src="media/<%=user.getImagenes()%>" alt="Imagen de cliente" />
			</div>
			<div class="col-md-6 col-12">
				<p>
					Tipo de Usuario: <b>Cliente</b>
				</p>
				<p>
					Nickname: <b><%=user.getNick()%></b>
				</p>
				<p>
					Nombre: <b><%=user.getNombre()%></b>
				</p>
				<p>
					Apellido: <b><%=user.getApellido()%></b>
				</p>
				<p>
					Fecha de Nacimiento: <br>
					<b><%=user.getNacimientoFormateado()%></b>
				</p>
				...
				<form action="actualizarNotificaciones" method="get">
					...
					<div class="form-check">
						<input class="form-check-input" type="checkbox"
							...
							<%if (user.isNotificaciones()) {%> checked <%}%>> <label
							class="form-check-label" for="notificacionesCheckbox">
							Notificaciones Activas </label>
					</div>
					...
					<div class="col-md-8">
						<div class="card-body">
							...
							<span class="badge mb-2"
								style="background-color: green; font-weight: normal; color: white"><%=dt.getEstado()%></span>

							<%
							} else {
							%>
							<span class="badge mb-2"
								style="background-color: yellow; font-weight: normal; color: black"><%=dt.getEstado()%></span>
							...
							<p class="card-text">
								<b>Precio total: </b><%=dt.getPrecioTotal()%></p>
							<p class="card-text">
								<b>Fecha de compra: </b><%=dt.getFechaString()%></p>

							<button class="btn"
								style="border: none; background-color: #2C2C2C">
								<a style="text-decoration: none; color: white;"
									href='perfilOrden?nickname=<%=user.getNick()%>&orden=<%=dt.getNumero()%>'>VER
									DETALLES</a>
							</button>
